...
2. 이 글은 투자 조언이 아니라는 점을 본문 흐름에 자연스럽게 녹이거나 DISCLAIMER 항목에 명시하세요.
...
7. 답변은 이 메시지 맨 아래에 주어지는 출력 형식을 한 글자도 벗어나지 말고 정확히 지켜서
   작성하세요. 형식 마커(===TITLE=== 등) 앞뒤로 다른 설명이나 인사말을 덧붙이지 마세요.`;
}
